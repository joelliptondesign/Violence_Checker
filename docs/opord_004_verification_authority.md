...
| E — downstream workflow | Historical/object/self/correction/conflict/uncertainty context, deterministic presentation and preview, no external/provider call, empty/select/manual/run/stale Streamlit states, raw narrative display | `tests/test_comparison.py`, `tests/test_presentation.py`, `tests/test_salesforce_preview.py`, `tests/test_successor_downstream_authority.py`, `tests/test_streamlit_empty_state.py`, `tests/test_fixture_policy_regression.py` |
